...
export class Init81664871510487 implements MigrationInterface {
  name = 'Init81664871510487';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`group\` DROP COLUMN \`anotherEntityId\``,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`group\` ADD \`anotherEntityId\` int NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_d75e7d17def68fbe997934741a\` ON \`table_of_ref\` (\`groupId\`)`,
    );
